      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
        ...
        <div className="lg:col-span-2 space-y-5">
          ...
          <Card
            ...
            style={{ ['--home-insight-tone' as string]: 'var(--home-strategy-secondary)' }}
          >
            <div className="flex items-start gap-3">
              <div className="home-insight-icon w-8 h-8 rounded-lg bg-primary/10 flex items-center justify-center flex-shrink-0">
                <svg className="w-4 h-4 text-primary" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                </svg>
              </div>
              <div className="space-y-1.5 min-w-0">
                <h4 className="home-insight-title text-[11px] font-medium uppercase tracking-[0.16em]">{text.capitalFlow}</h4>
                {summary.capitalFlowSummary ? (
                  <p className="home-insight-body text-sm leading-6 whitespace-pre-wrap">
                    {summary.capitalFlowSummary}
                  </p>
                ) : (
