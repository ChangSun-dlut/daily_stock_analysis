...
from src.services.screening.scorer import _DEFAULT_SCORING_PROFILE
...
_TOP_LEVEL_KEYS = {
    ...
    "style",
    "screening",
    # LLM / workflow metadata – present in all strategy YAMLs
    "instructions",
    "aliases",
    "core_rules",
    "default_priority",
...
_SCORING_PROFILE_KEYS: set[str] = set(_DEFAULT_SCORING_PROFILE.keys())
_RISK_PROFILE_KEYS = {
    "chase_change_pct",
    "chase_points",
