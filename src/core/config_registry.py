...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "OPENCLAW_WECHAT_ACCOUNT": {
        "title": "OpenClaw 微信机器人账号",
        "description": "openclaw 微信频道机器人账号 ID，如 f4add82e8cf4-im-bot。可在 ~/.openclaw/openclaw-weixin/accounts/ 下查看。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OPENCLAW_WECHAT_TARGET": {
        "title": "OpenClaw 微信接收人",
        "description": "接收推送的微信 userId（iLink 平台），如 o9cq803K8OvJ6mTb0qsWMDB9dtfM@im.wechat。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "OPENCLAW_CLI_BIN": {
        "title": "OpenClaw CLI 路径",
        "description": "可选。openclaw CLI 可执行文件路径；留空则自动探测（which openclaw / npx openclaw）。",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "REPORT_TYPE": {
        "title": "Report Type",
        "description": "Report format: 'simple' (concise), 'full' (detailed), 'brief' (3-5 sentences), or 'concise' (header summary + one 6-column table, no per-stock expansion).",
        "category": "notification",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": ["simple", "full", "brief", "concise"],
        "validation": {"enum": ["simple", "full", "brief", "concise"]},
        "display_order": 55,
    ...
    "ALERT_REALTIME_PUSH": {
        "title": "Alert Realtime Push",
        "description": "Bypass alert cooldown and fingerprint deduplication so every triggered alert is pushed immediately. Enabling this can cause repeated intraday alerts for the same stock (e.g. every 5 minutes).",
        "category": "notification",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
        ...
        "validation": {},
        "display_order": 67,
        "help_key": "settings.notification.alert_realtime_push",
        "examples": [
            "ALERT_REALTIME_PUSH=false",
            "ALERT_REALTIME_PUSH=true",
        ],
        "docs": [],
        "warning_codes": [],
    },
...
_FIELD_HELP_METADATA: Dict[str, Dict[str, Any]] = {
    ...
    "OPENCLAW_WECHAT_ACCOUNT": {
        "help_key": "settings.notification.chat_bots",
        "examples": [
            "OPENCLAW_WECHAT_ACCOUNT=f4add82e8cf4-im-bot",
            "OPENCLAW_WECHAT_TARGET=o9cq803K8OvJ6mTb0qsWMDB9dtfM@im.wechat",
        ],
        "docs": _DOC_FULL_GUIDE_NOTIFICATION,
        "warning_codes": ["webhook_secret_value"],
    },
